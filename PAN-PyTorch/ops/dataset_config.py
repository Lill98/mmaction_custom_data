...
ROOT_DATASET = '/content/mmaction_custom_data/data/customdata/'


def return_custom(modality):
    filename_categories = 2 #put your class hear
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET + 'rawframes'
        filename_imglist_train = '/content/mmaction_custom_data/data/customdata/customdata_train_split_1_rawframes.txt'
        filename_imglist_val = '/content/mmaction_custom_data/data/customdata/customdata_val_split_1_rawframes.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'customdata':return_custom }
